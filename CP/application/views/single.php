			...
			<div class="col-sm-8 col-sm-offset-2">
 				...
 				<article class="post">
					...
					<div class="entry-content"> 
						<p><img alt="" src="<?php echo base_url('assets/images/mac.jpg') ?>"></p>
						<p>
			...
			<div class="col-sm-8 col-sm-offset-2">
				...
				<div id="comments">	
					...
					<ol class="comments-list">
						<li class="comment">
							<div>
								<img src="<?php echo base_url('assets/images/avatar_man.png') ?>" alt="Avatar" class="avatar">
						...
						<li class="comment">
							<div>
								<img src="<?php echo base_url('assets/images/avatar_woman.png') ?>" alt="Avatar" class="avatar">
...
<footer id="footer" class="topspace">
	<div class="container">
		<div class="row">
			...
			<?php echo form_open_multipart(site_url('c_single/input_komentar')); ?>
				<div class="col-md-3 widget">
